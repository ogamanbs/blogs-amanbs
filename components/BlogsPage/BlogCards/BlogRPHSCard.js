...
const BlogRPHSCard = () => {
    return (
        <div className="w-full md:w-64 flex flex-col p-2 rounded-[30px] transition ease-in-out">
            <Link href="/react-password-hide-show">
                <div className="relative w-full md:w-auto h-48 md:h-36 rounded-[20px] border border-zinc-600 overflow-hidden cursor-pointer">
